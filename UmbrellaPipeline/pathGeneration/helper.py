...
def get_params(param_directory:str) -> app.charmmparameterset.CharmmParameterSet:
    ...
    """
    paramfile = param_directory + 'openmm/toppar.str' if param_directory.endswith('/') else param_directory + '/openmm/toppar.str'
...
def gen_box(psf: str or app.CharmmPsfFile, pdb: str or app.PDBFile) -> List[unit.Quantity]:
    """
